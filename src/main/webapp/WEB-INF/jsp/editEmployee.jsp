...
<body>
<form:form  name="miforma" action="/moduleEmployees/updateEmployee" method="post" modelAttribute="employee" onsubmit=" return validateDates();">
<form:hidden path="id"/> 
<form:hidden path="deleteOp"/> 
 <table>

<tr>
<td align="center" colspan="2"><b>Edit Employee</b></td>
</tr>
...
<tr>
<td align="center"><button type="submit">Update</button>
<td align="center"><button type="button" onclick="javascript:deleteEmployee();">Delete</button>
</td>
</tr>
</form:form>
